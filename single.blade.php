...
@section('content')
    <article id="post-{{ $currentMovie->id }}" class="post-{{ $currentMovie->id }} hentry" itemscope="itemscope"
        ...
        <div class="bixbox animefull">
            <div class="bigcover">
                <div class="ime"><a href="{{ $watchUrl }}" class="lnk" aria-label="{{ $currentMovie->name }}"></a> <img
                ...
                <div class="infox">
                    ...
                    <div class="ninfo">
                        ...
                        <div class="info-content">
                            ...
                            @endif
                            <div class="desc">
                                Xem phim  {!! $currentMovie->regions->map(function ($region) {
                                            return '<a href="' .
                                                $region->getUrl() .
                                                '" tite="Phim ' .
                                                $region->name .
                                                ' rel="tag"" style="color: red;">' .
                                                $region->name .
                                                '</a>';
                                        })->implode(', ') !!} có phụ đề tiếng việt trên {{ request()->getHost() }}.
                                Bạn cũng có thể tải xuống phim vietsub miễn phí, đừng quên xem phát
                                trực tuyến với nhiều chất lượng khác nhau 720P 360P 240P 480P (nếu có) tùy theo đường truyền
                                của bạn để tiết kiệm dung lượng internet. Hãy chia sẻ {{ request()->getHost() }} tới mọi người để cùng thưởng thức nhé.
                            </div>
                        </div>
                    </div>
                </div>
